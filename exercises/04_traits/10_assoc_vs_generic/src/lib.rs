...
trait Power<T> {
    fn power(self: Self, exponent: T) -> Self;
}

impl Power<u16> for u32 {
    fn power(self: Self, mut exponent: u16) -> Self {
        let mut result = self;
        while exponent > 1 {
            result *= self;
            exponent -= 1;
...
impl Power<u32> for u32 {
    fn power(self: Self, mut exponent: u32) -> Self {
        let mut result = self;
        while exponent > 1 {
            result *= self;
            exponent -= 1;
...
impl Power<&u32> for u32 {
    fn power(self: Self, exponent: &u32) -> Self {
        let mut result = self;
